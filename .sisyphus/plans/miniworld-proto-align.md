...
- [x] 1. 删除 `#include "UDPProxyServer.h"`，添加 MiniWorld 子消息常量
...
- [x] 2. 移除 `UDPProxyServer*` 变量和 `LoginToCoordinator` 调用
...
- [x] 3. 添加 `ID_UDP_PROXY_GENERAL` (0x5C) 消息处理
...
- [x] 4. 将 `ID_UDP_PROXY_GENERAL` 注册触发子 Peer 创建
